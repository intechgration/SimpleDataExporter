...
{
    class SumInfo : IDisposable
    {
        private dynamic _swObj;
        //public string GetProductVersion(string regEntry)
        //{
        //    string version = string.Empty;
        //    Dictionary<string, object> keyValuePairs;

        //    using (var settingsRegKey = Registry.LocalMachine.OpenSubKey(regEntry))
        //    {
        //        var valueNames = settingsRegKey.GetValueNames();
        //        keyValuePairs = valueNames.ToDictionary(name => name, settingsRegKey.GetValue);
        //        object versionTemp = string.Empty;
        //        if (keyValuePairs != null)
        //        {
        //            if (keyValuePairs.TryGetValue("Version", out versionTemp) == true)
        //            {
        ...
        {
             _swObj = Marshal.GetActiveObject("Summation.Application");
